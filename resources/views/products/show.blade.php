            ...
            <div class="grid lg:grid-cols-2 gap-8">
                            ...
                            @if ($product->image)
                                <div
                                    ...
                                    @if ($product->discount > 0)
                                        <div
                                            class="absolute top-4 left-4 bg-red-500 text-white px-2 py-1 text-xs font-bold rounded-full">
                                            -{{ $product->discount }}%
                                        </div>
                                    @endif
                                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                <span class="text-gray-600 font-medium">Disusun Oleh:</span>
                                <span class="text-gray-900 font-semibold">{{ $product->disusun }}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-100">
                                <span class="text-gray-600 font-medium">Jumlah Modul:</span>
                                <span class="text-gray-900 font-semibold">{{ $product->jumlah_modul }} modul</span>
                            </div>
                            <div class="flex justify-between items-center py-2">
                                <span class="text-gray-600 font-medium">Bahasa:</span>
                                <span class="text-gray-900 font-semibold">{{ $product->bahasa }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="prose prose-gray max-w-none bg-white border border-gray-200 rounded-xl p-4">
