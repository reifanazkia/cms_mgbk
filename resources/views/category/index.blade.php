...
@section('content')
            ...
            <table class="min-w-full bg-white border border-gray-200 text-sm">
                ...
                <tbody id="categoryTable">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border space-x-1">
                                ...
                                <form action="{{ route('category.destroy', $category->id) }}" method="POST" class="inline delete-form">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                            class="delete-btn text-red-600 hover:text-red-800 px-2 py-1 text-xs border border-red-300 rounded hover:bg-red-50">
                                        Hapus
                                    </button>
                                </form>
                            </td>
                    ...
                    @if ($categories->isEmpty())
                        <tr>
                            <td colspan="4" class="text-center p-4 text-gray-500">Belum ada data kategori.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
    ...
    <script>
        ...
        function openEditModal(id) {
            const categoryData = window.categories?.find(category => category.id == id);
            if (!categoryData) {
            ...
            form.action = `{{ url('/category/update') }}/${categoryData.id}`;
        ...
        // SweetAlert success & error session
        @if (session('success'))
            Swal.fire({
                title: 'Berhasil!',
